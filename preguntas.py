...
def pregunta_01():
    ...
    df = pd.read_csv("https://raw.githubusercontent.com/analitica-predictiva/regresion-logistica-mushrooms-ATHidalgo/main/mushrooms.csv")
...
def pregunta_03():
    ...
    pipeline = Pipeline(
        steps=[
            ...
            ("classifier", LogisticRegression(Cs=10)),
        ],
    )
